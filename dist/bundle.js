...
const endpoint = "https://convertertechexam.azurewebsites.net/converter";
new Vue({
    ...
    methods: {
        async Convert() {
            try {
                let response = await _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(endpoint + `/${this.convertType}/${this.ammountToConvert}`);
